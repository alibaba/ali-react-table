...
// NAMESPACE OBJECT: ./examples/biz/rank-table.stories.tsx
var rank_table_stories_namespaceObject = {};
__webpack_require__.r(rank_table_stories_namespaceObject);
__webpack_require__.d(rank_table_stories_namespaceObject, "default", function() { return rank_table_stories; });
__webpack_require__.d(rank_table_stories_namespaceObject, "RankTable", function() { return RankTable; });
...
var format = __webpack_require__(250);
...
// EXTERNAL MODULE: ./src/assets/WebsiteBaseTable.tsx
var WebsiteBaseTable = __webpack_require__(256);

// CONCATENATED MODULE: ./examples/biz/rank-table.stories.tsx
/* harmony default export */ var rank_table_stories = ({title:'业务示例 / 商品排行榜'});const StyledBaseTable=Object(styled_components_browser_esm["b" /* default */])(WebsiteBaseTable["a" /* WebsiteBaseTable */])`
  --border-color: none;
...
`;function RankTable(){return/*#__PURE__*/react_default.a.createElement(StyledBaseTable,{style:{paddingRight:16},columns:[{name:'排名',code:'rank',width:50},{name:'商品名称',code:'sku_name'},{name:'指标',code:'value',render:format["amount"],width:100,align:'right'},{name:'环比',code:'rated',render:format["lfl"],width:100,align:'right'},{name:'周比',code:'ratew',render:format["lfl"],width:100,align:'right'}],dataSource:[{rank:1,sku_name:'青浦白鹤红颜草莓300g',value:1234567,rated:0.0123456,ratew:0.087654},{rank:2,sku_name:'凤达草鸡蛋12枚',value:1234567,rated:0.0123456,ratew:0.087654},{rank:3,sku_name:'Dole进口甜香蕉650g',value:1234567,rated:0,ratew:-0.087654},{rank:4,sku_name:'崇明芦笋350g',value:1234567,rated:0.0123456,ratew:0.087654},{rank:5,sku_name:'北海道原味吐司面包210g',value:1234567,rated:-0.0123456,ratew:-0.087654},{rank:6,sku_name:'盒马珍珠生虾仁150g',value:1234567,rated:0.0123456,ratew:0.087654},{rank:7,sku_name:'洛川红富士苹果4个',value:1234567,rated:-0.0123456,ratew:-0.087654},{rank:8,sku_name:'湾仔码头大白菜猪肉水饺300g',value:1234567,rated:0.0123456,ratew:0.087654},{rank:9,sku_name:'牛奶小蛋糕',value:1234567,rated:0.0123456,ratew:0},{rank:10,sku_name:'六记雄潮汕牛肉丸250g',value:1234567,rated:0.0123456,ratew:0.087654}]});}
// EXTERNAL MODULE: ./examples/helpers/Stories.tsx
var Stories = __webpack_require__(499);

// CONCATENATED MODULE: ./examples/biz/rank-table.mdx
var frontMatter={id:'rank-table',title:'商品排行榜',hide_table_of_contents:true,hide_title:true};var metadata={"unversionedId":"biz/rank-table","id":"biz/rank-table","isDocsHomePage":false,"title":"商品排行榜","source":"@site/examples/biz/rank-table.mdx","slug":"/biz/rank-table","permalink":"/examples/biz/rank-table","editUrl":"https://github.com/alibaba/ali-react-table/edit/master/packages/website/examples/biz/rank-table.mdx","version":"current","sidebar":"sidebar","previous":{"title":"典型数据报表","permalink":"/examples/biz/data-report"},"next":{"title":"用户留存矩阵","permalink":"/examples/biz/remain-matrix"}};/* @jsx mdx */var rightToc=[];var layoutProps={rightToc:rightToc};var MDXLayout="wrapper";function MDXContent(_ref){var components=_ref.components,props=Object(objectWithoutPropertiesLoose["a" /* default */])(_ref,["components"]);return Object(esm["b" /* mdx */])(MDXLayout,Object(esm_extends["a" /* default */])({},layoutProps,props,{components:components,mdxType:"MDXLayout"}),Object(esm["b" /* mdx */])(Stories["a" /* Stories */],{stories:rank_table_stories_namespaceObject,path:"biz/rank-table.stories.tsx",mdxType:"Stories"}));};MDXContent.isMDXComponent=true;
...
/* harmony import */ var numeral__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(439);
/* harmony import */ var numeral__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(numeral__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(151);
...
/* harmony import */ var ali_react_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(257);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(172);
// @ts-ignore
const DarkBaseTable=Object(styled_components__WEBPACK_IMPORTED_MODULE_3__[/* default */ "b"])(ali_react_table__WEBPACK_IMPORTED_MODULE_1__[/* BaseTable */ "a"])`
  --bgcolor: #333;
  ...
  --border-color: #3c4045;
`;const WebsiteBaseTable=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.forwardRef((props,ref)=>{const{isDarkTheme}=Object(_theme_hooks_useThemeContext__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])();// 下面的写法下，切换主题将导致组件重新加载
// 如果要避免重新加载，可以使用 styled-components 提供的 css 方法
const Table=isDarkTheme?DarkBaseTable:ali_react_table__WEBPACK_IMPORTED_MODULE_1__[/* BaseTable */ "a"];return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(Table,Object.assign({ref:ref},props));});
...
var createForOfIteratorHelperLoose = __webpack_require__(434);
...
var collectNodes = __webpack_require__(421);
...
var esm_createForOfIteratorHelperLoose = __webpack_require__(201);

// EXTERNAL MODULE: ../ali-react-table/src/utils/getTreeDepth.ts
var getTreeDepth = __webpack_require__(422);
...
var SpanManager = __webpack_require__(253);
...
var ResizeObserver_es = __webpack_require__(223);
...
var loading = __webpack_require__(237);
...
/* harmony import */ var _isLeafNode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(186);
/** 遍历所有节点，并将节点收集到一个数组中.
 * order 参数可用于指定遍历规则：
 * * `pre` 前序遍历
 * * `post` 后续遍历
 * * `leaf-only` 忽略内部节点，只收集叶子节点
 * */function collectNodes(nodes,order){const result=[];dfs(nodes);return result;function dfs(nodes){for(const node of nodes){if(Object(_isLeafNode__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(node)){result.push(node);}else{if(order==='pre'){result.push(node);dfs(node.children);}else if(order==='post'){dfs(node.children);result.push(node);}else{dfs(node.children);}}}}}
...
/* harmony import */ var _Users_feichao_sfc_code_github_alibaba_ali_react_table_node_modules_babel_runtime_helpers_esm_createForOfIteratorHelperLoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(201);
...
/* harmony import */ var _alifd_next__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(166);
/* harmony import */ var _alifd_next__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(185);
/* harmony import */ var _docusaurus_BrowserOnly__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(495);
