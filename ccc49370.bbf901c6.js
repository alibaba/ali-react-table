...
`;function U(e){const{isDarkTheme:t}=Object(B.a)();if("undefined"==typeof window)return null;const n=t?"chromeDark":"chromeLight";return l.a.createElement(G.a,Object(o.a)({theme:n},e))}const Y={React:l.a,...l.a,fusion:D,...D,styled:w.b,cx:c.a,art:s,...s,artPivot:r,...r,createAggregateFunction:_.a,assets:H,docHelpers:a,BaseTable:V,CrossTable:e=>l.a.createElement(P,Object(o.a)({BaseTableComponent:V},e)),CrossTreeTable:e=>l.a.createElement(I,Object(o.a)({BaseTableComponent:V},e))};t.a=Y},393:function(e,t,n){"use strict";var r=n(0),a=n.n(r);var o=function(e,t,n){const[a,o]=Object(r.useState)(void 0);Object(r.useEffect)((()=>{let r,i;function l(){const l=function(){let e=0,t=null;for(r=document.getElementsByClassName("anchor");e<r.length&&!t;){const a=r[e],{top:o}=a.getBoundingClientRect();o>=0&&o<=n&&(t=a),e+=1}return t}();if(l){let n=0,r=!1;for(i=document.getElementsByClassName(e);n<i.length&&!r;){const e=i[n],{href:c}=e,s=decodeURIComponent(c.substring(c.indexOf("#")+1));l.id===s&&(a&&a.classList.remove(t),e.classList.add(t),o(e),r=!0),n+=1}}}return document.addEventListener("scroll",l),document.addEventListener("resize",l),l(),()=>{document.removeEventListener("scroll",l),document.removeEventListener("resize",l)}}))},i=n(48),l=n.n(i);const c="table-of-contents__link";function s({headings:e,isChild:t}){return e.length?a.a.createElement("ul",{className:t?"":"table-of-contents table-of-contents__left-border"},e.map((e=>a.a.createElement("li",{key:e.id},a.a.createElement("a",{href:"#"+e.id,className:c,dangerouslySetInnerHTML:{__html:e.value}}),a.a.createElement(s,{isChild:!0,headings:e.children}))))):null}t.a=function({headings:e}){return o(c,"table-of-contents__link--active",100),a.a.createElement("div",{className:l.a.tableOfContents},a.a.createElement(s,{headings:e}))}}}]);