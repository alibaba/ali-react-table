...
基础表格 `BaseTable`是 ali-react-table 中各个表格组件的底层组件，提供了基本的表格渲染能力。BaseTable 只提供了基本的表格渲染能力，一些常见的表格功能（排序、树状模式等）详见 <LinkTo kind="表格常见功能 / 文档" story="page">表格常见功能</LinkTo>.
