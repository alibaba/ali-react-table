...
<Meta title="表格常见功能 / 文档" />

# 表格常见功能

ali-react-table 提供了业务开发中经常需要用到的一些功能，这些功能采用 **统一的拓展机制** 进行实现。

ali-react-table 提供的常用功能如下：

- <LinkTo kind="表格常见功能 / 常用功能 / 树状模式" story="page">
    树状模式
  </LinkTo>
- <LinkTo kind="表格常见功能 / 常用功能 / 排序" story="page">
    排序
  </LinkTo>
- <LinkTo kind="表格常见功能 / 常用功能 / 列高亮" story="page">
    列高亮
  </LinkTo>
- <LinkTo kind="表格常见功能 / 常用功能 / 单元格自动合并" story="page">
    单元格自动合并
  </LinkTo>
- <LinkTo kind="表格常见功能 / 常用功能 / 拖拽调整列宽" story="page">
    拖拽调整列宽
  </LinkTo>
- <LinkTo kind="表格常见功能 / 常用功能 / 其他功能" story="page">
    其他功能
  </LinkTo>
