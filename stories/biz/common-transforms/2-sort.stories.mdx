...
<Meta title="表格常见功能 / 常用功能 / 排序" />

# 排序

本页文档将介绍 ali-react-table 提供的排序的相关 API。本页中的示例源码可在 <LinkTo kind="表格常见功能 / 常见功能示例" story="表格排序-单列">表格常见功能-常见功能示例</LinkTo> 查看。
...
<Preview>
  <Story id="表格常见功能-常见功能示例--表格排序-单列" />
</Preview>
...
<Preview>
  <Story id="表格常见功能-常见功能示例--树状模式与层级排序" />
</Preview>
...
<Preview>
  <Story id="表格常见功能-常见功能示例--自定义样式的排序表头" />
</Preview>
