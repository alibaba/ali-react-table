...
- **Break Change: 移除 ali-react-table/biz 入口**
  - 1.0 以前不会真正移除，只添加了警告
- **Break Change: 移除 commonTransforms， commonTransforms.XXX 改名为 makeXXXTransform**
  - 1.0 以前不会真正移除，只添加了警告
...
- **Break Change: 移除 useOperationBar 和 CustomColumnsDialog**
  - 1.0 以前不会真正移除，只添加了警告
- 其他
  - 文档目录优化
  - 支持 SSR
...
<summary style={{ margin: '16px 0', cursor: 'pointer' }}>点击展开 v0.13 &amp; v0.12 日志</summary>
...
<summary style={{ margin: '16px 0', cursor: 'pointer' }}>点击展开开源前的更新日志</summary>
