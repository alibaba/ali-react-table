...
- <LinkTo kind="表格 / 常用功能 / 树状模式" story="page">
    树状模式
  </LinkTo>
- <LinkTo kind="表格 / 常用功能 / 排序" story="page">
    排序
  </LinkTo>
- <LinkTo kind="表格 / 常用功能 / 列高亮" story="page">
    列高亮
  </LinkTo>
- <LinkTo kind="表格 / 常用功能 / 单元格自动合并" story="page">
    单元格自动合并
  </LinkTo>
- <LinkTo kind="表格 / 常用功能 / 拖拽调整列宽" story="page">
    拖拽调整列宽
  </LinkTo>
- <LinkTo kind="表格 / 常用功能 / 其他功能" story="page">
    其他功能
  </LinkTo>
